...
namespace drualcman
{
    public class Encriptacion : Hash
    {
        ...
        public string Encrypt(string clearText, string EncryptionKey)
        {
            ...
            {
                Rfc2898DeriveBytes pdb = new Rfc2898DeriveBytes(EncryptionKey, new byte[] { 0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76 }, 69, HashAlgorithmName.SHA256);
